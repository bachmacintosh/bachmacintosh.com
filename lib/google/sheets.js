...
export async function getGtaSheets() {
    ...
    // Summary
    response.data.valueRanges[0].values.forEach(function(col,) {
    ...
    // Wish List
    response.data.valueRanges[1].values.forEach(function(col,) {
    ...
    // Earnings
    response.data.valueRanges[2].values.forEach(function(col,) {
    ...
    // Properties
    response.data.valueRanges[3].values.forEach(function(col,) {
        if(content.properties.length === 0) {
            ...
            let exists = content.properties.find(function(object, index,) {
    ...
    // Vehicles
    response.data.valueRanges[4].values.forEach(function(col,) {
        if(content.vehicles.length === 0) {
            ...
            let exists = content.vehicles.find(function(object, index,) {
    ...
    // Safes
    response.data.valueRanges[5].values.forEach(function(col,) {
        content.safes.push({
            location: col[0],
            safeCapacity: col[1],
            moneyPerIgDay: col[2],
