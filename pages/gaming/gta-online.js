    ...
    return(
        <DefaultLayout>
            ...
            <Disclosure defaultOpen="open">
                {({open,}) => (
                    <>
                        <Disclosure.Button><Heading2>[{open ? '-': '+'}] Summary</Heading2></Disclosure.Button>
                        <Disclosure.Panel>
            ...
            <Disclosure>
                {({open,}) => (
                    <>
                        <Disclosure.Button><Heading2>[{open ? '-': '+'}] Earnings</Heading2></Disclosure.Button>
                        <Disclosure.Panel>
