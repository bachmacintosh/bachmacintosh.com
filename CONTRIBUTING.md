...
This project relies on Cypress End-to-End Tests to make sure pages on the site load correctly. Your changes must pass the included tests and/or add/update new/existing tests to cover the changes. This project does not require 100% coverage, but any forced tests that are added for the sake of a green checkmark will mean a rejected PR.
